...
//	static int frameBufferAttributes[] = {GLX_RGBA,GLX_RED_SIZE,1,GLX_GREEN_SIZE,1,GLX_BLUE_SIZE,1,GLX_ALPHA_SIZE,1,None};	right only for 2D without buffer
//	static int frameBufferAttributes[] = { GLX_RGBA, GLX_DEPTH_SIZE, 24, GLX_DOUBLEBUFFER, None };						this is wrong
//	static int frameBufferAttributes[] = { GLX_RGBA, GLX_DEPTH_SIZE, 24, GLX_DOUBLEBUFFER, None }; 						this is wrong 
	...
	XStoreName(gpDisplay,gWindow,"Native XWindows Perspective 2D Rotation Colorful Triangle and Square");
