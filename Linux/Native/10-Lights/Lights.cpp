...
//	static int frameBufferAttributes[] = {GLX_RGBA,GLX_RED_SIZE,1,GLX_GREEN_SIZE,1,GLX_BLUE_SIZE,1,GLX_ALPHA_SIZE,1,None};		try this and enjoy the uncommented part
//	static int frameBufferAttributes[] = { GLX_RGBA, GLX_DEPTH_SIZE, 24, GLX_DOUBLEBUFFER, None };
	...
	XStoreName(gpDisplay,gWindow,"Native XWindows Perspective 3D Rotation Colorful Triangle and Square");
